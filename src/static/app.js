  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        // Create participants section with delete icon
        ...
        if (details.participants.length > 0) {
          ...
          details.participants.forEach(participant => {
            participantsHTML += `<li><span class='participant-email'>${participant}</span> <span class='delete-participant' title='Remove participant' data-activity='${encodeURIComponent(name)}' data-email='${encodeURIComponent(participant)}'>&#128465;</span></li>`;
          });
          participantsHTML += "</ul>";
        } else {
